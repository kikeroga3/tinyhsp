...
//
// For MinGW:
// $ g++ -static cutehspx_al.cpp -o cutehspx -std=gnu++11 -lglfw3dll -lopengl32 -lopenal32 -mwindows
// $ g++ -static cutehspx_al.cpp -o cutehspx_c -std=gnu++11 -lglfw3dll -lopenal32 -lopengl32
// or -std=gnu++11
// or -std=c++0x
// or -std=gnu++0x
// or -std=c++11
...
*/
	...
	{
		// OpenAL
		alcMakeContextCurrent(NULL); // 現在のコンテキストの解除
		alcDestroyContext(al_context); // コンテキストの消去
		alcCloseDevice(al_device); // デバイスを閉じる
	}
	glfwTerminate();
