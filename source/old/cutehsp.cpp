// For macOS:
// $ clang++ cutehsp.cpp -o cutehsp -std=c++11 -lglfw -framework OpenGL
//
// For MinGW:
...
//
// For Linux:
// $ g++ cutehsp.cpp -o cutehsp -lglfw3 -lX11 -lXrandr -lXinerama -lXi -lXxf86vm -lXcursor -lGL -lpthread -ldl
//
